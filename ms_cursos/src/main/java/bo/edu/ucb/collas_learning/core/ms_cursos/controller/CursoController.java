...
public class CursoController {
    ...
    public List<CursoDTO> getAllCursos() {
        ...
        // Simulación: se crean dos cursos dummy
    ...
    public CursoDTO getCursoById(
        ...
        // Simulación: si id es 999 se simula que no se encontró el curso
        if (id == 999) {
        ...
        return new CursoDTO(
                id,
                "Curso Dummy " + id,
                "Descripción dummy del curso " + id,
                "Etiqueta dummy",
                new Timestamp(System.currentTimeMillis()),
                true,
    ...
    public CursoDTO createCurso(
        ...
        // Simulación: se asigna un ID dummy, por ejemplo 100
        curso.setCodCurso(100);
        return curso;
    }
    ...
    public void deleteCurso(
        ...
        // Simulación: se procede a eliminar el curso.
    }
}
